        ...
        <div class="form-holder">
            <div class="form-content">
                <div class="form-items">
                    <h3>Đăng nhập</h3>
                    <form method="post" action="/account?action=login" class="requires-validation" novalidate>
                        <div class="col-md-12">
                        ...
                        <a href="/account?action=register" class="form-button mt-3">
                            <button id="submit" type="submit" class="btn btn-primary mt-3">Đăng nhập</button>
                        </a>
                    </form>
                </div>
            </div>
